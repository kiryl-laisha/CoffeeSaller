...
public class CoffeeVolumesDescendingComparator implements Comparator<Coffee> {

    @Override
    public int compare(Coffee firstCoffee, Coffee secondCoffee) {

        return Double.compare(secondCoffee.getFoodProductVolume(), firstCoffee.getFoodProductVolume());
    }
}
